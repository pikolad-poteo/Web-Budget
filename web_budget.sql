...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 09 2026 г., 14:11
...
(28, 1, 'Wishlist', 'expense', '#8e44ad', 'bi-bag-heart', '2026-04-09 11:40:12'),
(29, 1, 'Wishlist2', 'expense', '#cccccc', 'bi-tag', '2026-04-09 12:07:53');
...
(46, 1, 1, 1, 28, -0.01, '2026-04-09', 'Покупка из Wishlist: Vibe POWERBOX250.2 autovõimendi | Noor Tehnik | Магазин: https://noortehnik.ee/vibe-powerbox250-2-autovoimendi', NULL, '2026-04-09 12:08:22');
...
INSERT INTO `wishlist` (`id`, `family_id`, `account_id`, `user_id`, `category_id`, `title`, `description`, `amount`, `planned_date`, `priority`, `status`, `who`, `store_url`, `image_url`, `image_local_path`, `linked_transaction_id`, `created_at`, `updated_at`) VALUES
(6, 2, 2, 2, 23, 'Набор кухонных контейнеров', 'Для хранения продуктов дома.', 1800.00, '2026-04-08', 'low', 'planned', 'Анна', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(7, 2, 2, 2, 3, 'Самокат', 'Покупка самоката для города.', 7600.00, '2026-04-20', 'high', 'planned', 'Пользователь', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(8, 2, 2, 2, 9, 'Подписка на семейный сервис', 'Годовая семейная подписка.', 2990.00, '2026-03-08', 'medium', 'cancelled', 'Пользователь', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(9, 2, 2, 2, 13, 'Стеллаж в кладовку', 'Хотим организовать хранение вещей.', 8900.00, '2026-05-10', 'medium', 'postponed', 'Анна', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(10, 3, 3, 3, 15, 'План покупок для недели', 'Тестовая wish-позиция для семьи календаря.', 1000.00, '2026-04-12', 'medium', 'planned', 'Пользователь', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(11, 3, 3, 3, 25, 'Ноутбук для учёбы', 'Нужен к началу следующего семестра.', 42000.00, '2026-06-01', 'high', 'planned', 'Илья', NULL, NULL, NULL, NULL, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(12, 3, 3, 3, 12, 'Курс по математике', 'Онлайн-обучение на 3 месяца.', 6900.00, '2026-04-18', 'low', 'bought', 'Пользователь', NULL, NULL, NULL, 41, '2026-04-09 09:40:56', '2026-04-09 09:40:56'),
(13, 1, 1, 1, 10, 'Gas MAD A1-70.2 autovõimendi | Noor Tehnik', NULL, 1.00, NULL, 'medium', 'bought', NULL, 'https://noortehnik.ee/gas-mad-a1-70-2-autovoimendi', 'https://noortehnik.ee/images/products/gas-gas-mad-a1-70-2-autovoimendi-1.webp', NULL, NULL, '2026-04-09 11:51:22', '2026-04-09 11:52:23'),
(14, 1, 1, 1, 29, 'Audison Thesis TH due autovõimendi | Noor Tehnik', NULL, 2.00, NULL, 'medium', 'bought', NULL, 'https://noortehnik.ee/audison-thesis-th-due-autovoimendi', 'https://noortehnik.ee/images/products/audison-audison-thesis-th-due-autovoimendi-1.webp', NULL, NULL, '2026-04-09 11:53:26', '2026-04-09 12:08:03'),
(15, 1, 1, 1, 28, 'Vibe POWERBOX250.2 autovõimendi | Noor Tehnik', NULL, 0.01, NULL, 'medium', 'bought', NULL, 'https://noortehnik.ee/vibe-powerbox250-2-autovoimendi', 'https://noortehnik.ee/images/products/vibe-vibe-powerbox250-2-autovoimendi-1.webp', NULL, 46, '2026-04-09 12:08:15', '2026-04-09 12:08:22');
...
ALTER TABLE `wishlist`
  ...
  ADD KEY `fk_wishlist_transaction` (`linked_transaction_id`);
...
ALTER TABLE `wishlist`
  ...
  ADD CONSTRAINT `fk_wishlist_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_wishlist_family` FOREIGN KEY (`family_id`) REFERENCES `families` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_wishlist_transaction` FOREIGN KEY (`linked_transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
